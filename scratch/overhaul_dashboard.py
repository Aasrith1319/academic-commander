...
with open(r"c:\Users\AASRITH\Downloads\academic commander\app\main.py", "w", encoding="utf-8") as f:
    f.write(code_content)

print("SUCCESS: app/main.py rewritten completely with live interactive features!")
